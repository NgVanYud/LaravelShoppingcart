...
namespace NgDuy\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use NgDuy\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use NgDuy\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use NgDuy\Shoppingcart\ShoppingcartServiceProvider;
use NgDuy\Tests\Shoppingcart\Fixtures\ProductModel;
use NgDuy\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \NgDuy\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \NgDuy\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \NgDuy\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \NgDuy\Shoppingcart\Cart
     */
